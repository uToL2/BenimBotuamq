...
<head>
    ...
    <title><?php echo $page_title ?> - Aquaman</title>
                ...
                <div style="z-index: 5 !important; " class="card login-box-container">
                    <div class="card-body">
                        ...
                        <div style="margin-top: 30px;" class="authent-text">
                            <p> <span style="font-size: 20px;">AQUAMAN</span> 'a Hoşgeldiniz!</p>
                        ...
                        <center>
                            ...
                            <a style="background-color: #0088cc; width: 369px" class="btn btn-primary" href="https://t.me/mernisAquaman">
