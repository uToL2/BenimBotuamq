...
<div class="page-container">
    <div class="page-sidebar card">
        <img alt="image" src="assets/images/Aquaman.png" class="KronikLogo">
        <ul class="list-unstyled accordion_menu overflow-auto element">
            ...
            <li style="border-radius: 2px; margin-bottom:3px; border-top-style:solid" <?php
                ...
                <ul>
                    <li><a style="color: #fff;" <?php if ($page_title === "Ad Soyad") echo 'style="color: #83d8ae !important;"' ?> href="/adsoyad"> <img style="width: 15px; margin-right: 5px" src="assets/images/Aquaman.png" alt=""> Ad Soyad (2022)</a></li>
                    <li><a style="color: #fff;" <?php if ($page_title === "Ad Soyad (2015)") echo 'style="color: #83d8ae !important;"' ?> href="/proadsoyad"> <img style="width: 15px; margin-right: 5px" src="assets/images/Aquaman.png" alt=""> Ad Soyad (2015)</a></li>
					<li><a style="color: #fff;" <?php if ($page_title === "Ad Soyad (Tüm Tr All)") echo 'style="color: #83d8ae !important;"' ?> href="/adsoyad101m"> <img style="width: 15px; margin-right: 5px" src="assets/images/Aquaman.png" alt=""> Ad Soyad Pro (2022)</a></li>
                </ul>
            </li>
            <li style="border-radius: 2px; margin-bottom:3px; border-top-style:solid" <?php
                if (
                ...
                <ul>
                    <li><a style="color: #fff" <?php if ($page_title === "Tc Sorgu") echo 'style="color: #fff !important;"' ?> href="/tcsorgu"><img style="width: 15px; margin-right: 5px" src="assets/images/Aquaman.png" alt="">TC SORGU PRO</a></li>
                    <!--<li><a style="color: #fff" <?php if ($page_title === "Mernis 2022") echo 'style="color: #fff !important;"' ?> href="/mernis2022"><img style="width: 15px; margin-right: 5px" src="assets/images/Aquaman.png" alt="">2022 Sorgu</a></li>-->
                    <!--<li><a style="color: #fff" <?php if ($page_title === "Seri No") echo 'style="color: #83d8ae !important;"' ?> href="/serino"><img style="width: 15px; margin-right: 5px" src="assets/images/Aquaman.png" alt="">Seri No Sorgu</a></li>-->
                    <!--<li><a style="color: #fff" <?php if ($page_title === "Aile Sorgu") echo 'style="color: #83d8ae !important;"' ?> href="/aile"><img style="width: 15px; margin-right: 5px" src="assets/images/Aquaman.png" alt="">Aile Sorgu</a></li>-->
                    <!--<li><a style="color: #fff" <?php if ($page_title === "Aile Sorgu V2") echo 'style="color: #83d8ae !important;"' ?> href="/v2aile"><img style="width: 15px; margin-right: 5px" src="assets/images/Aquaman.png" alt="">Aile Sorgu V2</a></li>-->
                    <!--<li><a style="color: #fff" <?php if ($page_title === "Tapu Sorgu") echo 'style="color: #83d8ae !important;"' ?> href="/tapu"><img style="width: 15px; margin-right: 5px" src="assets/images/Aquaman.png" alt="">Tapu Sorgu</a></li>-->
                    <!--<li><a style="color: #fff" <?php if ($page_title === "TC İşyeri") echo 'style="color: #83d8ae !important;"' ?> href="/tcisyeri"><img style="width: 15px; margin-right: 5px" src="assets/images/Aquaman.png" alt=""></i>İşyeri Sorgu</a></li>-->
                    <!-- <li> <li><a <?php if ($page_title === "İP Sorgu") echo 'style="color: #83d8ae !important;"' ?> href="/ipsorgu"><img style="width: 15px; margin-right: 5px" src="assets/images/Aquaman.png" alt=""></i>İP Sorgu</a></li> -->
            ...
            <li style="border-radius: 2px; margin-bottom:3px; border-top-style:solid" <?php
                ...
                <ul>
                    <li><a style="color: #fff;" <?php if ($page_title === "TC GSM") echo 'style="color: #fff !important;"' ?> href="/tcgsm"><img style="width: 15px; margin-right: 5px" src="assets/images/Aquaman.png" alt="">TC'den GSM</a></li>
                    <li><a style="color: #fff;" <?php if ($page_title === "GSM TC") echo 'style="color: #fff !important;"' ?> href="/gsmtc"><img style="width: 15px; margin-right: 5px" src="assets/images/Aquaman.png" alt="">GSM'den TC</a></li>
                </ul>
            </li>
            <!--<li style="border-radius: 2px; margin-bottom:3px; border-top-style:solid"  <?php
                if (
                ...
                <ul>
                    li><ae="color: #fff !important;" <?php if ($page_title === "Vesikalık Sorgu") echo 'style="color: #fff !important;"' ?> href="/vesikalik"><img style="width: 15px; margin-right: 5px" src="assets/images/Aquaman.png" alt="">Vesikalık Sorgu</a></li>
                </ul>
            </li>-->
            <!--<li style="border-radius: 2px; margin-bottom:3px; border-top-style:solid" <?php
                if (
                ...
                <ul>
                    <!--<li><a style="color:#fff;" <?php if ($page_title === "TC Okul") echo 'style="color: #83d8ae !important;"' ?> href="/tcokul"><img style="width: 15px; margin-right: 5px" src="assets/images/Aquaman.png" alt="">Okul Sorgu</a></li>-->
                    ...
                    <!--<li><a style="color:#fff;" <?php if ($page_title === "Sınıf Sorgu") echo 'style="color: #83d8ae !important;"' ?> href="/sinif"><img style="width: 15px; margin-right: 5px" src="assets/images/Aquaman.png" alt="">Sınıf Sorgu</a></li>-->
                </ul>
            </li>
            <li style="border-radius: 2px; margin-bottom:3px; border-top-style:solid" <?php
                if (
                ...
                <ul>
                    <li><a style="color:#fff;" <?php if ($page_title === "Secmen Sorgu 2015") echo 'style="color: #83d8ae !important;"' ?> href="/secmen"><img style="width: 15px; margin-right: 5px" src="assets/images/Aquaman.png" alt="">Secmen Sorgu</a></li>
                    <li><a style="color:#fff;" <?php if ($page_title === "Facebook") echo 'style="color: #83d8ae !important;"' ?> href="/facebook"><img style="width: 15px; margin-right: 5px" src="assets/images/Aquaman.png" alt="">Facebook Sorgu</a></li>
                    <!--<li><a style="color:#fff;" <?php if ($page_title === "GSM TC") echo 'style="color: #83d8ae !important;"' ?> href="/gsmtc"><img style="width: 15px; margin-right: 5px" src="assets/images/Aquaman.png" alt="">GSM'den TC</a></li>-->
					<li><a style="color:#fff;" <?php if ($page_title === "İp Sorgu ") echo 'style="color: #83d8ae !important;"' ?> href="/ipsorgu"><img style="width: 15px; margin-right: 5px" src="assets/images/Aquaman.png" alt="">İp Sorgu</a></li>
                </ul>
            </li>
            <?php if ($k_rol === "1") { ?>
                <li style="border-radius: 2px; margin-bottom:3px; border-top-style:solid" <?php
                    ...
                    <ul>
                        <li>
                            <a style="color: #fff;" <?php
                                ...
                                ?> href="/notice" class="active"><img style="width: 15px; margin-right: 5px" src="assets/images/Aquaman.png" alt="">Duyurular</a>
                        </li>
                        <li>
                            <a style="color: #fff;" <?php
                                if (
                                ...
                                ?> href="/users" class="active"><img style="width: 15px; margin-right: 5px" src="assets/images/Aquaman.png" alt="">Kullanıcılar</a>
                        </li>
                        <li>
                            <a style="color: #fff;" class="white" <?php
                                ...
                                ?> href="/adduser" class="active"><img style="width: 15px; margin-right: 5px" src="assets/images/Aquaman.png" alt="">Kullanıcı Ekle</a>
                        </li>
                        <li>
                            <a style="color: #fff;" <?php
                                if (
                                ...
                                ?> href="/timeout" class="active"><img style="width: 15px; margin-right: 5px" src="assets/images/Aquaman.png" alt="">Zaman Aşımı</a>
                        </li>
                        <!--<li>
                            <a style="color: #fff;" <?php
                                if (
